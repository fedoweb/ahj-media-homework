...
.geolocation_btn {
  ...
  background-color: white;
  border-radius: 5px;
}`, "",{"version":3,"sources":["webpack://./src/css/style.css"],"names":[],"mappings":"AAAA;EACE,yCAAyC;EACzC,WAAW;AACb;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,YAAY;AACd;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,SAAS;EACT,eAAe;EACf,gBAAgB;AAClB;;AAEA;EACE,aAAa;EACb,QAAQ;EACR,aAAa;EACb,sBAAsB;EACtB,mBAAmB;AACrB;;AAEA;EACE,iBAAiB;EACjB,eAAe;EACf,sBAAsB;AACxB;;AAEA;EACE,kBAAkB;EAClB,aAAa;EACb,gBAAgB;EAChB,gBAAgB;;AAElB;;AAEA;EACE,WAAW;EACX,YAAY;EACZ,sBAAsB;EACtB,mBAAmB;AACrB;;AAEA;EACE,kBAAkB;EAClB,QAAQ;EACR,WAAW;AACb;;AAEA;EACE,WAAW;EACX,YAAY;EACZ,uBAAuB;EACvB,sBAAsB;EACtB,kBAAkB;EAClB,eAAe;AACjB;;AAEA;EACE,kBAAkB;EAClB,QAAQ;EACR,SAAS;EACT,gCAAgC;EAChC,sBAAsB;EACtB,SAAS;;EAET,gBAAgB;EAChB,uBAAuB;AACzB;;AAEA;EACE,SAAS;EACT,UAAU;AACZ;;AAEA;EACE,cAAc;EACd,mBAAmB;AACrB;;AAEA;EACE,gBAAgB;AAClB;;AAEA;EACE,iBAAiB;EACjB,eAAe;AACjB;;AAEA;EACE,cAAc;EACd,YAAY;EACZ,sBAAsB;EACtB,uBAAuB;EACvB,kBAAkB;AACpB","sourcesContent":["body {\n  font-family: Arial, Helvetica, sans-serif;\n  color: gray;\n}\n\n.line_container {\n  display: flex;\n  flex-direction: column;\n  height: 95vh;\n}\n\n.line_list {\n  display: flex;\n  flex-direction: column;\n  gap: 10px;\n  max-height: 90%;\n  overflow: scroll;\n}\n\n.line_item {\n  display: flex;\n  gap: 5px;\n  padding: 10px;\n  border: 1px solid gray;\n  border-radius: 10px;\n}\n\n.line_time {\n  margin-left: auto;\n  margin-right: 0;\n  min-width: fit-content;\n}\n\n.line_form {\n  position: relative;\n  display: flex;\n  margin-top: auto;\n  margin-bottom: 0;\n  \n}\n\n.form_text {\n  width: 100%;\n  height: 40px;\n  border: 1px solid gray;\n  border-radius: 10px;\n}\n\n.btn_container {\n  position: absolute;\n  top: 7px;\n  right: 10px;\n}\n\n.btn {\n  width: 30px;\n  height: 30px;\n  background-color: white;\n  border: 1px solid gray;\n  border-radius: 50%;\n  cursor: pointer;\n}\n\n.custom_geolocation {\n  position: absolute;\n  top: 50%;\n  left: 50%;\n  transform: translate(-50%, -50%);\n  flex-direction: column;\n  gap: 10px;\n\n  max-width: 400px;\n  background-color: white;\n}\n\n.custom_geolocation_text {\n  margin: 0;\n  padding: 0;\n}\n\n.custom_geolocation_content {\n  color: inherit;\n  font-style: inherit;\n}\n\n.custom_geolocation_content::placeholder {\n  color: lightgray;\n}\n\n.custom_geolocation_btn {\n  margin-left: auto;\n  margin-right: 0;\n}\n\n.geolocation_btn {\n  color: inherit;\n  padding: 5px;\n  border: 1px solid gray;\n  background-color: white;\n  border-radius: 5px;\n}"],"sourceRoot":""}]);
// Exports
...
var TimeLine = /*#__PURE__*/function () {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 13:
              ...
              console.error("Не удалось получить координаты:", _context.t0.message);
  ...
  return _createClass(TimeLine, [{
    ...
    key: "renderItem",
    value: function () {
      var _renderItem = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(text, position) {
        var date, item;
